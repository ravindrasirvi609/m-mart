...
import { updateCampaignProductsAction } from "@/actions/campaign-actions";
...
export function CampaignProductsForm({
  campaignId,
  allProducts,
  onSuccess,
}: CampaignProductsFormProps) {
  ...
  // Load existing campaign products on mount
  useEffect(() => {
    let mounted = true;
    fetch(`/api/admin/entity-products?campaign_id=${campaignId}`)
      .then((res) => res.json())
      .then((data) => {
