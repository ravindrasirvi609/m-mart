  ...
  return (
    ...
    >
      ...
      <div className="mt-3 space-y-3">
        ...
        <Input
          name="net_qty"
          placeholder="Net quantity (e.g. 200 ml, 1 kg)"
          className="!bg-white/5 !text-text-main"
          disabled={isPending}
        />
        ...
        <Textarea
          name="image_urls"
          placeholder='Additional image URLs (JSON array, e.g. ["url1", "url2"])'
          rows={2}
        ...
        <Textarea
          ...
          placeholder='Product highlights (JSON, e.g. {"Weight": "200 ml", "Type": "Gel"})'
          rows={2}
          className="!bg-white/5 !text-text-main font-mono text-xs"
          disabled={isPending}
        />
