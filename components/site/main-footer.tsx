...
export function MainFooter() {
  return (
    <footer className="mt-14 border-t border-[#b41611]/20 bg-gradient-to-br from-[#8f120f] via-[#b41511] to-[#d12618] pb-20 text-white sm:pb-0">
      <div className="mx-auto grid w-full max-w-[1180px] gap-8 px-4 py-10 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
        <section className="space-y-3">
          ...
          <p className="text-sm leading-6 text-white/85">
            Grocery shopping with fast dispatch, high-quality essentials, and
            secure payment confirmation.
          </p>
        </section>

        <section>
          <h3 className="text-xs font-extrabold uppercase tracking-[0.16em] text-white/85">
            Shop
          </h3>
        ...
        <section className="space-y-3 text-sm">
          ...
          <a
            ...
            className="flex items-center gap-2 text-white/92 hover:text-white"
          >
            <Phone size={16} />
            {STORE.phone}
          </a>
      ...
      <div className="border-t border-white/20 py-3 text-center text-xs font-medium text-white/82">
        © {new Date().getFullYear()} Mmart. Built for a smooth online shopping
        experience.
      </div>
    </footer>
  );
